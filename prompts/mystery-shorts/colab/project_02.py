...
ROWS = [
 ...
 (20, "ただ", "3つ目がいちばんおかしい", "いちばんおかしい", "yellow", "zoomin",
      "ただ、3つ目がいちばんおかしいんだ。"),
 (21, "3", "ロンゴロンゴ", "ALL", "red", "zoomout", "3つ目、ロンゴロンゴ。"),
 (22, "イースター島に", "ロンゴロンゴという文字", "ロンゴロンゴ", "red", "zoomin",
      "イースター島に、ロンゴロンゴって文字があるんだ。"),
 (23, "木の板に刻まれた", "記号の列", "記号の列", "yellow", "panright",
      "木の板に刻まれた記号の列な。"),
 (24, "残ってる板は", "世界にたった26点", "26点", "red", "zoomin",
      "残ってる板は、世界にたった26点。"),
 (25, "19世紀に", "宣教師が来た頃には", "19世紀", "yellow", "zoomin",
      "19世紀に宣教師が来た頃にはな、"),
 (26, "読める島民が", "一人もいなかった", "一人も", "red", "zoomout",
      "読める島民が、一人もいなくなってたんだ。"),
 (27, "文字か記号かも", "決着がついてない", "ついてない", "red", "zoomin",
      "文字なのか記号なのかも、決着がついてない。"),
 (28, "ただ2024年", "板の一枚を測ったら", "2024年", "red", "zoomin",
      "ただ2024年、板の一枚を測ったらな、"),
 (29, "15世紀のものかも", "しれないと出た", "15世紀", "red", "panleft",
      "15世紀のものかもしれないと出たんだ。"),
 (30, "ヨーロッパ人が", "来るより前だ", "前", "red", "zoomin",
      "ヨーロッパ人が来るより前だぜ。"),
 (31, "人類が自力で作った", "数少ない例かも", "自力で", "yellow", "zoomout",
      "人類が自力で文字を作った、数少ない例かもしれない。"),
 (32, "文字は残った", "読める奴が消えた", "消えた", "red", "zoomin",
      "この三つ、文字のほうは残ってるんだ。"),
 (33, "文明が途切れるのは", "文字が消えた時じゃない", "文字が消えた時", "yellow", "zoomin",
      "消えたのは、読める人間のほうだ。"),
 (34, "今書いてるこの文字も", "いつか誰も読めなくなる", "誰も読めなくなる", "red", "zoomout",
      "今broたちが読んでるこの文字も、いつかそうなる。"),
 (35, "broたちはどれが", "一番読めそうだと思う？", "どれ", "yellow", "zoomin", None),
]

ITEM_END = {9, 19, 31}          # 項目の終わりで少し長めに間を取る
...
PROMPTS = {
 ...
 20: "A dark corridor of museum vitrines receding into black, one case at the far end still lit, " + _N,
 21: "Row of weathered wooden tablets covered in tiny carved glyphs, arranged in a dark museum drawer, " + _C,
 24: "A wooden tablet under museum glass, catalogue label beside it, dramatic spot lighting, deep shadows, " + _C,
 27: "Extreme macro of carved glyph rows on dark wood, grain and tool marks visible, " + _C,
 28: "Laboratory bench with a small wood sample under analytical instruments, cold clinical light, " + _C,
 29: "Aged wooden tablet fragment held in gloved hands against a black background, " + _C,
 31: "Silhouetted human hand carving the first mark into a blank wooden board by firelight, " + _C,
 34: "A modern smartphone screen glowing in total darkness, the text on it fading away character by character, " + _N,
 35: "Vast dark archive of unreadable documents receding into blackness, single dim light above, " + _N,
}
