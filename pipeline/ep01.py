...
render.SHOTS = [
 ...
 # ---- 1945年の発見のいきさつは切った。
 # 数字を出しているのが実測で18/21本、笑い・軽口が8/21本だったので足したが、
 # これは「電子レンジが何を温めているか」の話ではなく、ただの豆知識だった。
 # オチのあとに別の話題を開くことになって締まりが悪い。終わり方は実測でも
 # 「余韻・答え合わせ」が最多で、輪を閉じるものだった。
 # 概要欄には残してある（docs/post_ep01.md）。
 # 受ける相手がいなくなるので、視聴者役の「そんな理由で？」も一緒に外した。
